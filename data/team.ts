...
export const trainingLinks: TrainingLink[] = [
  ...
  { title: 'YAGSL (Swerve Library)', url: 'https://github.com/Yet-Another-Software-Suite/YAGSL', category: 'software' },
  { title: 'YAGSL Yapılandırma Sihirbazı', url: 'https://broncbotz3481.github.io/YAGSL-Lib/yagsl/yagsl.json', category: 'software' },
  { title: 'SPARK MAX Teknik İnceleme Kılavuzu', url: 'https://docs.revrobotics.com/brushless/spark-max', category: 'software' },
  { title: 'Limelight Vision Dokümantasyonu', url: 'https://docs.limelightvision.io/', category: 'software' },
  { title: 'AdvantageScope', url: 'https://github.com/Mechanical-Advantage/AdvantageScope', category: 'software' },
  { title: 'Shuffleboard (WPILib)', url: 'https://docs.wpilib.org/en/stable/docs/software/dashboards/shuffleboard/', category: 'software' },
  ...
  { title: 'Onshape FRC', url: 'https://www.onshape.com/en/education/first-robotics', category: 'mechanical' },
  { title: 'FRC Design', url: 'https://www.frcdesign.org/', category: 'mechanical' },
  { title: 'VEX Tekerlek', url: 'https://www.vexrobotics.com/wheels.html', category: 'mechanical' },
  { title: 'VEX Dişli', url: 'https://www.vexrobotics.com/gears.html', category: 'mechanical' },
